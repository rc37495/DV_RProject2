...
```{r}
source("~/DataVisualization/DV_RProject2/03 Visualizations/workflow1.R")
```
...
```{r}
source("~/DataVisualization/DV_RProject2/03 Visualizations/workflow2.R")
```
...
```{r}
source("~/DataVisualization/DV_RProject2/03 Visualizations/workflow3.R")
```
